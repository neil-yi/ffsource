...
public:
	...
	long    GetActualSize()	{return (long)field->GetActualSize();};
	long    GetDefinedSize(){return (long)field->GetDefinedSize();};
	long    GetAttributes()	{return (long)field->GetAttributes();};
...
public:
	...
	BOOL IsEof();
	BOOL IsBof();
	long GetRecordCount(){ return (long)m_rs->RecordCount;}
	long GetAbsolutePage(){return (long)m_rs->GetAbsolutePage();};
	void SetAbsolutePage(int nPage)	{m_rs->PutAbsolutePage((enum PositionEnum)nPage);};
	long GetPageCount()	{return (long)m_rs->GetPageCount();};
	long GetPageSize()	{return (long)m_rs->GetPageSize();};
	void SetPageSize(int nSize)	{m_rs->PutPageSize(nSize);};
	long GetAbsolutePosition()	{return (long)m_rs->GetAbsolutePosition();};
	...
	long GetNumFields()
		{return (long)m_rs->Fields->GetCount();};
