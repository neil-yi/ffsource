...
EPropertyTextblock* EPropertyTextblock::SetEditWindowFont( CFont* pFont )
{
	m_pEditWindowFont = pFont;
	return this;
}
...
bool EPropertyTextblock::OnCommand( EPropWnd* pParent , WPARAM wParam , LPARAM lParam )
{
	...
	if( m_pPropertyEditWindow == NULL )
	{
		...
		if( m_pEditWindowFont != NULL )
		{
			m_pPropertyEditWindow->SetEditFont( m_pEditWindowFont );
		}
