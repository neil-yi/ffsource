...
public:
    ...
    virtual void     DrawHover( CDC* pDC ,  EPropWnd* pView );						//override to draw yourself, call edfault implementation to clear property background
	...
	virtual int      CompareValues( EProperty* pProperty );
