...
#include <afxcmn.h>
#include "EPropListWnd.h"
#include "ECommentPane.h"
#include "EPropCtrlBase.h"

class GUILIBDLLEXPORT EPropCtrl : public EPropCtrlBase
{
...
public:
	...
	// Custom create without MFC window by Damian Trebilco
	void Create(HWND hWndParent, int nDestinationCWndID, const CRect& rect , IPropertyChangeListener* pListener = NULL );
	...
	void EnableAutoSizeKeyColumn(bool bEnable=true);
