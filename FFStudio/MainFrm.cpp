...
//	CreateCombos();
	...
	m_combo2.AddString( _T("m_TreeClassView.") );
	m_combo2.AddString( _T("m_TreeSolExplorer.") );
	m_combo2.AddString( _T("m_FileView->") );
...
void CMainFrame::CreateCombos()
{
	...
	m_comboFind.AddString( _T("m_TreeClassView.") );
	m_comboFind.AddString( _T("m_TreeSolExplorer.") );
	m_comboFind.AddString( _T("m_FileView->") );
