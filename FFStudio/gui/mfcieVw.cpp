...
CMfcieDoc* CMfcieView::GetDocument()
   { return (CMfcieDoc*)m_pDocument; }
#endif
...
void CMfcieView::OnInitialUpdate()
{
	...
	//CString str = "http://localhost/ueditor/_examples/completeDemo.html";
	//Navigate(str);
}
